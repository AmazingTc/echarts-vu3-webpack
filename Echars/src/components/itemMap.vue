<template>
    <div id="cc" class="itemMap" style="width: 100%; height: 100%;">
        123
    </div>
</template>
<script>
...
export default {
    setup() {
        ...
        function chartInit() {
            const myChart = $chart.init(document.getElementById('cc'))
            var geoCoordMap = {
                '上海': [121.4648, 31.2891],
                '东莞': [113.8953, 22.901],
                '东营': [118.7073, 37.5513],
            ...
            var XNData = [
                ...
                [{ name: '武汉' }, { name: '武汉', value: 200 }]
            ];

            var YCData = [
                [{ name: '北京' }, { name: '上海', value: 100 }],
                [{ name: '上海' }, { name: '上海', value: 300 }],
